                    ...
                    <form action="{{ route('site.events.register',$event) }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 border-right">
                                ...
                                {{--                                </div>--}}
                                <div class="form-group">
                                    <label for="specialite">3. Spécialité</label>
                                ...
                                <div class="form-group">
                                    <label for="wilaya_id">4. Wilaya</label>
                                ...
                                <div class="form-group">
                                    <label for="statut">5. Statut</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="email">6. Adresse E-Mail</label>
                                    <input type="email" name="email" id="email" class="form-control rounded-0" required
                                           value="{{ old('email') }}">
                                </div>
                                <div class="form-group">
                                    <label for="telephone">7. Numéro de télephone</label>
                                    <input type="number" name="telephone" id="telephone" class="form-control rounded-0"
                                           required value="{{ old('telephone') }}">
                                </div>
                                <div class="form-group">
                                    <label for="password">8. Mot de passe</label>
                                    <input type="password" name="password" id="password" class="form-control rounded-0"
                                           required value="{{ old('password') }}"
                                    placeholder="Huit (08) caractères minimum">
                                </div>
                                <div class="form-group">
                                    <label for="password_confirmation">9. Confirmer le mot de passe</label>
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                           class="form-control rounded-0" required>
                                </div>
                                <div class="form-group">

                                    <button class="btn btn-success btn-block rounded-0"><i class="fal fa-user-plus"></i> S'inscrire et
